...
public class VisaoVeiculo extends JFrame {
	...
	public VisaoVeiculo() {
		...
		//Modelo 
		lblModelo.setBounds(10, 50, 200, 20);
		add(lblModelo);
		txtModelo.setBounds(10, 70, 365, 20);
		add(txtModelo);
		
		//Cor
		lblCor.setBounds(10, 90, 200,20);
		add(lblCor);
		cboCor.setBounds(10, 110, 200, 20);
		add(cboCor);
		cboCor.addItem("-- Cor --");
